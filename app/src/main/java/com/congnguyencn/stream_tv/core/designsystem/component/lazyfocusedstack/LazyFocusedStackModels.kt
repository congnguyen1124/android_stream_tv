...
@Immutable
data class LazyFocusedStackItem<T>(val key: Any, val startMinute: Int, val endMinute: Int, val value: T) {
  init {
...
@Immutable
data class LazyFocusedStackColumn<C, T>(val key: Any, val header: C, val items: List<LazyFocusedStackItem<T>>)

@Immutable
data class LazyFocusedStackPosition(val columnIndex: Int, val itemIndex: Int)

internal data class LazyFocusedStackItemRange(val startMinute: Int, val endMinute: Int)
...
internal fun firstLazyFocusedStackPosition(columns: List<List<LazyFocusedStackItemRange>>): LazyFocusedStackPosition? {
