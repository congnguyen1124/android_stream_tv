...
internal class ContentRowItemProvider(private val intervals: List<ContentRowInterval>) : LazyLayoutItemProvider {
...
internal class ContentRowScopeImpl : ContentRowScope {
  ...
  override fun item(key: Any?, contentType: Any?, content: @Composable ContentRowItemScope.() -> Unit) {
...
private data class ResolvedContentRowItem(val interval: ContentRowInterval, val localIndex: Int)
